...
public class TccInfo implements java.io.Serializable {
    ...
    public Long getTccLinkId() {
        return tccLinkId;
    }

    public void setTccLinkId(Long tccLinkId) {
        this.tccLinkId = tccLinkId;
    }

    @Override
    public String toString() {
        return "TccInfo [id=" + id + ", tccLinkId=" + tccLinkId + ", type=" + type + ", key=" + key + ", value=" + value
                + ", userId=" + userId + ", referenceId=" + referenceId + ", expire=" + expire + ", version=" + version
